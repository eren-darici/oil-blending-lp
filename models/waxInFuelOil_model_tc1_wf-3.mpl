...
constraints := {
    ...
    -3.245*oils_A_L - 2.726*oils_B - 0.187*oils_Cond_ - 3.172*oils_Gu - 4.4814*oils_K - 4.4856*oils_L - 3.161*oils_L_G - 4.087*oils_M - 1.326*oils_Q - 0.57*oils_W_D <= 0,
